      ...
      <AuthProvider>
        <Routes>
          ...
          <Route
            path="/"
            element={
              <ProtectedRoute roles={AUTHORIZATION.INICIO}>
                <Start />
              </ProtectedRoute>
            }
          />
          <Route
            path="/centro_costo"
            element={
              <ProtectedRoute roles={AUTHORIZATION.BODEGA_PANEL}>
                <Folder />
              </ProtectedRoute>
            }
          />
          <Route
            path="/requisicion"
            element={
              <ProtectedRoute roles={AUTHORIZATION.RQ_PANEL}>
                <RQStart />
              </ProtectedRoute>
            }
          />
          <Route
            path="/oc"
            element={
              <ProtectedRoute roles={AUTHORIZATION.OC_PANEL}>
                <OCStart />
              </ProtectedRoute>
            }
          />
          <Route
            path="/remision"
            element={
              <ProtectedRoute roles={AUTHORIZATION.OC_LIST}>
                <RemisionStart />
              </ProtectedRoute>
            }
          />
          <Route
            path="/remision/viewer/:remisionId"
            element={
              <ProtectedRoute roles={AUTHORIZATION.OC_VIEWER}>
                <RemisionViewer />
              </ProtectedRoute>
            }
          />
          <Route
            path="/requisicion/editor"
            element={
              <ProtectedRoute roles={AUTHORIZATION.RQ_EDITOR}>
                <RQEditor />
              </ProtectedRoute>
            }
          />
          <Route
            path="/requisicion/list"
            element={
              <ProtectedRoute roles={AUTHORIZATION.RQ_LIST}>
                <RQViewList />
              </ProtectedRoute>
            }
          />
          ...
          />
          <Route
            path="/oc/editor/rq/:rqId"
            element={
              <ProtectedRoute roles={AUTHORIZATION.OC_EDITOR}>
                <OCEditor />
              </ProtectedRoute>
            }
          />
          ...
          />
          <Route
            path="/requisicion/viewer/:rqId"
            element={
              <ProtectedRoute roles={AUTHORIZATION.RQ_VIEWER}>
                <RQViewer />
              </ProtectedRoute>
            }
          />
          <Route
            path="/centro_costo/:parentId"
            element={
              <ProtectedRoute roles={AUTHORIZATION.BODEGA_CHILDREN}>
                <Subfolder />
              </ProtectedRoute>
            }
          />
          <Route
            path="/centro_costo/info/:folderId"
            element={
              <ProtectedRoute roles={AUTHORIZATION.BODEGA_VIEWER}>
                <BodegaInfo />
              </ProtectedRoute>
            }
          />
          <Route
            path="/admins"
            element={
              <ProtectedRoute roles={AUTHORIZATION.WORKER_LIST}>
                <GestionAdmins />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            path="/create/element"
            element={
              <ProtectedRoute roles={AUTHORIZATION.CREATE_ELEMENT}>
                <CreateElement />
              </ProtectedRoute>
            }
          />
          <Route
            path="/elementos"
            element={
              <ProtectedRoute roles={AUTHORIZATION.ELEMENT_LIST}>
                <Elementos />
              </ProtectedRoute>
            }
          />
          <Route
            path="/elemento/:id"
            element={
              <ProtectedRoute roles={AUTHORIZATION.ELEMENT_DETAILS}>
                <ElementInformation />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute roles={AUTHORIZATION.WORKER_DETAILS}>
                <UserPanel />
              </ProtectedRoute>
            }
          />
          <Route
            path="/epp"
            element={
              <ProtectedRoute roles={AUTHORIZATION.EPP}>
                <EppPage />
              </ProtectedRoute>
            }
          />
          ...
          <Route path="/stocklist/:id" element={<StockList />} />
        </Routes>
      </AuthProvider>
    </div>
  );
