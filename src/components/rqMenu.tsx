...
import ADD_FOLDER from "../assets/icon/mmcndmgr.dll_14_30612-1.png";
...
export default function RqMenu() {
  ...
  const handleModal = (menu: "RQ_ITEMS" | "GENERAL" | "ADD_MATERIAL" | "ADD_FOLDER") => {
    setModal(true);
    setRqOption(menu);
  };
    ...
    <CreateRqProvider>
      <div className="bottom_start right" style={{ justifyContent: "flex-end" }}>
        <div className="options">
          <div className="option_container" onClick={() => handleModal("RQ_ITEMS")}>
            <div className="tooltip">
              <img src={ADD_ELEMENT} alt="Añadir elemento" className="option_icon" />
              <span className="tooltiptext">Añadir ítem RQ</span>
            </div>
          </div>
          <div
          ...
          >
            <div className="tooltip">
              ...
              <span className="tooltiptext">Opciones generales</span>
            </div>
          </div>
          <div
            className="option_container"
            onClick={() => {
              handleModal("ADD_FOLDER");
            }}
          >
            <div className="tooltip">
              <img src={ADD_FOLDER} alt="Editar" className="option_icon" />
              <span className="tooltiptext">Crear centro de costo</span>
            </div>
          </div>
          <div
            className="option_container"
          ...
          >
            <div className="tooltip">
              ...
              <span className="tooltiptext">Crear elemento</span>
            </div>
          </div>
